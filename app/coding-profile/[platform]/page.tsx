        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex items-start justify-between gap-4 mb-6">
            <div>
              ...
              <Button asChild className="gap-2 transition-all duration-200 hover:scale-105">
          ...
          {/* Problems Solved */}
          <div className="rounded-lg border border-border bg-card p-6 animate-in fade-in slide-in-from-top duration-500 delay-300 hover:shadow-lg transition-all" style={{ animationDelay: '300ms' }}>
            <div className="flex items-center gap-2 mb-3">
          ...
          {/* Rank */}
          <div className="rounded-lg border border-border bg-card p-6 animate-in fade-in slide-in-from-top duration-500 delay-400 hover:shadow-lg transition-all">
            <div className="flex items-center gap-2 mb-3">
